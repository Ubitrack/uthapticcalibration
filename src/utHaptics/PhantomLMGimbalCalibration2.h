 ...
 */
UTHAPTICS_EXPORT Math::Matrix< float, 3, 3 > computePhantomLMGimbalCalibration2( const std::vector< Math::Vector< float, 3 > > & jointangles, 
...
UTHAPTICS_EXPORT Math::Matrix< double, 3, 3 > computePhantomLMGimbalCalibration2( const std::vector< Math::Vector< double, 3 > > & jointangles, 
